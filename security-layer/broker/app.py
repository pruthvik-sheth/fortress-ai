...
BROKER_API_KEY = os.getenv("BROKER_API_KEY", "DEMO-KEY-12345")
CAPABILITY_SECRET = os.getenv("CAPABILITY_SECRET", "super-secret-jwt-key")
AGENT_URL = os.getenv("AGENT_URL", "http://agent:7000")
INGRESS_AUDITOR = os.getenv("INGRESS_AUDITOR", "off") == "on"

LOG_FILE = "/app/data/broker_log.jsonl"
...
RBAC_MAP = {
    BROKER_API_KEY: ["*"],  # Demo key allows all agents
}
